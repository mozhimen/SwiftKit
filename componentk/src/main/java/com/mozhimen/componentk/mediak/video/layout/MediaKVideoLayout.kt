package com.mozhimen.componentk.mediak.video.layout
...
class MediaKVideoLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private var _videoGravity = CMediaKVideoGravity.NONE
    ...
    override fun initView() {
        ...
        if (_videoGravity != CMediaKVideoGravity.NONE) {
            zoomVideoSize()
            zoomTextureSize()
        }
    }
    ...
    fun initVideo(
        pathOrUrl: String,
        videoGravity: Int = CMediaKVideoGravity.NONE,
    ...
    private fun zoomTextureSize() {
        val screenWidth: Int = UtilKScreen.getRealWidth()
        val screenHeight: Int = UtilKScreen.getRealHeight()
        var scaleX = 1.0f
        var scaleY = 1.0f
