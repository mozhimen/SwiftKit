package com.mozhimen.componentk.mediak.audio.manager.focus
 ...
 * @Version 1.0
 */
class MediaKAudioManagerFocus(
    context: Context,
    private val _listener: IMediaKAudioManagerFocusListener? = null
) : OnAudioFocusChangeListener, IMediaKAudioManagerFocus {
