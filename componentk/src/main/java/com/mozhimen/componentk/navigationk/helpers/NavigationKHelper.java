package com.mozhimen.componentk.navigationk.helpers;
 ...
 */
@Navigator.Name("navigationk")
public class NavigationKHelper extends Navigator<NavigationKHelper.Destination> {
    private static final String TAG = "NavigatorK>>>>>";
    ...
    public NavigationKHelper(@NonNull Context context, @NonNull FragmentManager manager,
                             int containerId) {
        mContext = context;
    ...
    public static class Destination extends NavDestination {
        ...
        public Destination(@NonNull NavigatorProvider navigatorProvider) {
            this(navigatorProvider.getNavigator(NavigationKHelper.class));
        }
