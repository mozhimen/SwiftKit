 ...
 *
 * <p> If {@link CameraXKPreviewView} uses a {@link SurfaceView} to display the preview
 ...
 * {@link TextureView}, which applies to {@link CameraXKPreviewView} as well.
 *
 * @see <a href="https://developer.android.com/training/transitions#Limitations</a>
 */
@RequiresApi(21) // TODO(b/200306659): Remove and replace with annotation on package-info.java
@SuppressLint("RestrictedApi")
public final class CameraXKPreviewView extends FrameLayout {

    private static final String TAG = "CameraXKPreviewView>>>>>";
    ...
    @SuppressWarnings("WeakerAccess")
    @NonNull
    final MutableLiveData<androidx.camera.view.PreviewView.StreamState> mPreviewStreamStateLiveData =
    ...
    final Preview.SurfaceProvider mSurfaceProvider = new Preview.SurfaceProvider() {
        ...
        @SuppressLint({"UnsafeOptInUsageError", "RestrictedApi", "LongLogTag"})
        @Override
        @AnyThread
        public void onSurfaceRequested(@NonNull SurfaceRequest surfaceRequest) {
            ...
            surfaceRequest.setTransformationInfoListener(
                    ...
                    transformationInfo -> {
                        ...
                        if (camera.getCameraInfoInternal().getLensFacing() == CameraSelector.LENS_FACING_FRONT) {
                            isFrontCamera = true;
                        }
                        Log.d(TAG, "onSurfaceRequested: isFrontCamera" + isFrontCamera);
            ...
            mImplementation = shouldUseTextureView(surfaceRequest, mImplementationMode)
                    ? new TextureViewImplementation(CameraXKPreviewView.this, mPreviewTransform)
                    : new SurfaceViewImplementation(CameraXKPreviewView.this, mPreviewTransform);
    ...
    @UiThread
    public CameraXKPreviewView(@NonNull Context context) {
        this(context, null);
    }

    @UiThread
    public CameraXKPreviewView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @UiThread
    public CameraXKPreviewView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public CameraXKPreviewView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr,
        ...
        final TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs,
                androidx.camera.view.R.styleable.PreviewView, defStyleAttr, defStyleRes);
        ViewCompat.saveAttributeDataForStyleable(this, context, androidx.camera.view.R.styleable.PreviewView, attrs,
                attributes, defStyleAttr, defStyleRes);

        try {
            final int scaleTypeId = attributes.getInteger(
                    androidx.camera.view.R.styleable.PreviewView_scaleType,
                    mPreviewTransform.getScaleType().getId());
            setScaleType(ScaleType.fromId(scaleTypeId));

            int implementationModeId =
                    attributes.getInteger(androidx.camera.view.R.styleable.PreviewView_implementationMode,
    ...
    /**
     * Sets the {@link ImplementationMode} for the {@link CameraXKPreviewView}.
     *
     * <p> {@link CameraXKPreviewView} displays the preview with a {@link TextureView} when the
     ...
     *
     * @return The {@link ImplementationMode} for {@link CameraXKPreviewView}.
     */
    @SuppressLint("RestrictedApi")
    @UiThread
    @NonNull
     ...
     *
     * <p> If a {@link CameraController} is attached to {@link CameraXKPreviewView}, the change will take
     ...
     * {@link CameraXKPreviewView}, if any.
     *
     * <p> The returned {@link MeteringPointFactory} is capable of creating {@link MeteringPoint}s
     * from (x, y) coordinates in the {@link CameraXKPreviewView}. This conversion takes into account its
     * {@link ScaleType}. The {@link MeteringPointFactory} is automatically adjusted if the
     * {@link CameraXKPreviewView} layout or the {@link ScaleType} changes.
     *
     * <p> The {@link MeteringPointFactory} returns invalid {@link MeteringPoint} if the
     * preview is not ready, or the {@link CameraXKPreviewView} dimension is zero. The invalid
     ...
     * {@link CameraXKPreviewView}, or {@code null} if the camera preview hasn't started yet.
     * <p>
     ...
     * displayed on the {@link CameraXKPreviewView}, or null if the camera preview hasn't started yet.
     */
    @UiThread
    @Nullable
    ...
    /**
     * Gets a {@link ViewPort} based on the current status of {@link CameraXKPreviewView}.
     *
     * <p> Returns a {@link ViewPort} instance based on the {@link CameraXKPreviewView}'s current width,
     ...
     * matches the aspect ratio of the {@link CameraXKPreviewView}.
     *
    ...
    /**
     * Converts {@link ScaleType} to {@link ViewPort.ScaleType}.
     */
    ...
    /**
     * The implementation mode of a {@link CameraXKPreviewView}.
     *
     * <p> User preference on how the {@link CameraXKPreviewView} should render the preview.
     * {@link CameraXKPreviewView} displays the preview with either a {@link SurfaceView} or a
     ...
     * {@link CameraXKPreviewView} to decide what is the best internal implementation given the device
    ...
    public enum ImplementationMode {
         ...
         * doesn't support {@link SurfaceView}, {@link CameraXKPreviewView} will fall back to use a
         * {@link TextureView} instead.
         *
         * <p>{@link CameraXKPreviewView} falls back to {@link TextureView} when the API level is 24 or
         * lower, the camera hardware support level is
         * {@link CameraCharacteristics#INFO_SUPPORTED_HARDWARE_LEVEL_LEGACY}, or
         * {@link Preview#getTargetRotation()} is different from {@link CameraXKPreviewView}'s display
         * rotation.
         *
         ...
         * support arbitrary rotations. Do not use this mode if the {@link CameraXKPreviewView}
     ...
     *
     * <p> Once set, the controller will use {@link CameraXKPreviewView} to display camera preview feed.
     * It also uses the {@link CameraXKPreviewView}'s layout dimension to set the crop rect for all the use
     * cases so that the output from other use cases match what the end user sees in
     * {@link CameraXKPreviewView}. It also enables features like tap-to-focus and pinch-to-zoom.
     *
     ...
     * detached until it's set on the {@link CameraXKPreviewView} again.
     *
    ...
    /**
     * Gets the {@link OutputTransform} associated with the {@link CameraXKPreviewView}.
     *
     ...
     * {@link CameraXKPreviewView}'s layout is not ready.
     *
     * <p> {@link CameraXKPreviewView} needs to be in {@link ImplementationMode#COMPATIBLE} mode for the
     ...
     * mode is used.
     *
     * @return the transform applied on the preview by this {@link CameraXKPreviewView}.
