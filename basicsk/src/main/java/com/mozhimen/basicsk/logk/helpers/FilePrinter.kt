 ...
 * @Version 1.0
 */
class FilePrinter(private val logPath: String, private val retentionTime: Long) : ILogKPrinter {

    private val EXECUTOR = Executors.newSingleThreadExecutor()
    private var writer: LogKWriter
    ...
    override fun print(config: LogKConfig, level: Int, tag: String, printString: String) {
        ...
        worker.put(LogKMo(timeMillis, level, tag, printString))
    }
    ...
    private fun doPrint(logKMo: LogKMo) {
        ...
        writer.append(logKMo.flattenedLog())
    }
    ...
    private inner class PrintWorker : Runnable {
        private val logs: BlockingQueue<LogKMo> = LinkedBlockingQueue()
     ...
     */
    private inner class LogKWriter {
