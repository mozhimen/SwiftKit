...
object FpsKMonitor {
    ...
    fun listener(callback: FpsKCallback) {
        _fpsKViewer.addListener(callback)
    }

    interface FpsKCallback {
    ...
    private class FpsKViewer {
        ...
        init {
            ...
            _frameMonitor.addListener(object : FpsKMonitor.FpsKCallback {
        ...
        fun addListener(callback: FpsKCallback) {
