...
internal class FrameMonitor : Choreographer.FrameCallback {
    ...
    private var _listeners = arrayListOf<FpsKMonitor.FpsKCallback>()

    fun addListener(listener: FpsKMonitor.FpsKCallback) {
    ...
    override fun doFrame(frameTimeNanos: Long) {
        ...
        if (_frameStartTime > 0) {
            ...
            if (timeSpan > 1000) {
                ...
                LogK.e("FrameMonitor", fps)
                for (listener: FpsKMonitor.FpsKCallback in _listeners) {
