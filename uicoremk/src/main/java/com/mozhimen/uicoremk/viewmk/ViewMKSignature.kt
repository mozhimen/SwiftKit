...
/**
 * @ClassName ViewMKSignature
 * @Description TODO
 * @Author mozhimen / Kolin Zhao
 * @Date 2022/1/10 22:34
 * @Version 1.0
 */
class ViewMKSignature @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.ViewMKSignature)
        lineWidth =
            typedArray.getDimensionPixelSize(R.styleable.ViewMKSignature_viewMKSignature_lineWidth, lineWidth)
        typedArray.recycle()
        initPaint()
    }
