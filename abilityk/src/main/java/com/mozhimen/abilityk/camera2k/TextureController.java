...
import com.sensetime.notable.render.filter.AFilter;
import com.sensetime.notable.render.filter.GroupFilter;
import com.sensetime.notable.render.filter.NoFilter;
import com.sensetime.notable.render.utils.EasyGlUtils;
import com.sensetime.notable.render.utils.Gl2Utils;
import com.sensetime.notable.render.utils.MatrixUtils;
...
public class TextureController implements GLSurfaceView.Renderer {
    ...
    private CameraFilter mEffectFilter;                        //特效处理的Filter
    public GroupFilter mGroupFilter;                           //中间特效
    ...
    private float[] SM = Gl2Utils.getOriginalMatrix();                           //用于绘制到屏幕上的变换矩阵
    ...
    private void init() {
        ...
        mEffectFilter = new CameraFilter(mContext.getResources());
            ...
            setEGLWindowSurfaceFactory(new EGLWindowSurfaceFactory() {
                ...
                public EGLSurface createWindowSurface(EGL10 egl, EGLDisplay display, EGLConfig
                    ...
                    try {
                        ...
                        Log.e("TextureController",e.getMessage());
                    }
                    return null;
                }
