package com.mozhimen.navigationkcompiler;
...
@SupportedAnnotationTypes({"com.mozhimen.navigationkannor.NavigationKDestination"})
public class NavigationKProcessor extends AbstractProcessor {
    ...
    private static final String OUTPUT_FILE_NAME = "navigationKDestination.json";
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        Set<? extends Element> elements = roundEnvironment.getElementsAnnotatedWith(NavigationKDestination.class);
        //Set<? extends Element> elements = roundEnvironment.getElementsAnnotatedWith(NavigationKDestinationActivity.class);
        if (!elements.isEmpty()) {
            HashMap<String, JSONObject> destMap = new HashMap<>();
            handleDestination(elements, NavigationKDestination.class, destMap);
            try {
    ...
    private void handleDestination(Set<? extends Element> elements, Class<NavigationKDestination> destinationClass, HashMap<String, JSONObject> destMap) {
        for (Element element : elements) {
            TypeElement typeElement = (TypeElement) element;
            //全类名
            String clazzName = typeElement.getQualifiedName().toString();

            NavigationKDestination annotation = typeElement.getAnnotation(destinationClass);
