...
import com.mozhimen.basick.utilk.kotlin.text.substringEndSeparator
...
object ManifestKPermissionScopedUtil : IUtilK {
    ...
    fun strFilePath2strUriDocumentAndroidData(strFilePath: String): String {
        val tempStrUri = strFilePath.substringEndSeparator().replace("/storage/emulated/0/", "").replace("/", "%2F")
