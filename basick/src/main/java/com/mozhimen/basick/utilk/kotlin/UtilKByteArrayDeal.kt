...
object UtilKByteArrayDeal {
     ...
     */
    @JvmStatic
    fun joinBytesOf2(bytes1: ByteArray, bytes2: ByteArray): ByteArray {
     ...
     */
    @JvmStatic
    fun joinBytesOf5(bytes1: ByteArray, bytes2: ByteArray, bytes3: ByteArray, bytes4: ByteArray, bytes5: ByteArray): ByteArray {
