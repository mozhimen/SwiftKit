 ...
 * true 则赋值, 否则不赋值
 */
open class VarDeleg_SetFun_VaryNonnull_GetFun_Nonnull<T>(defaultValue: T, private val _get: T, private val _onSet: IVarDelegate_SetFun_Invoke<T>) : ReadWriteProperty<Any?, T> {
    @Volatile
