...
object CView {
    object SystemUi {
         ...
         * @See FLAG_FULLSCREEN 也会被自动清除，因此StatusBar也会同时显示出来
         */
        @ASenseKSystemBarMultiProperty(
         ...
         * @See FLAG_LAYOUT_FULLSCREEN
         * @See FLAG_LAYOUT_HIDE_NAVIGATION
         ...
         * @See FLAG_FULLSCREEN
         * @see FLAG_HIDE_NAVIGATION 一起使用的, 当使用FLAG_HIDE_NAVIGATION 隐藏导航栏时，配合此特性，只有
         ...
         * 此Flag只有配合
         * @see FLAG_FULLSCREEN
         * @see FLAG_HIDE_NAVIGATION 使用时才会起作用
         */
        @ASenseKSystemBarMultiProperty(
            CSystemBarType.IMMERSED_LIGHT,
            CSystemBarType.IMMERSED_FORCE,
