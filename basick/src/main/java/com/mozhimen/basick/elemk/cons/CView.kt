...
object CView {
    object SystemUiFlag {
         ...
         * [FULLSCREEN] 也会被自动清除，因此StatusBar也会同时显示出来
         */
         ...
         * 稳定布局, 主要是在全屏和非全屏切换时, 布局不要有大的变化.一般和 [LAYOUT_FULLSCREEN] [LAYOUT_HIDE_NAVIGATION]
         ...
         * 当window设置 [CWinMgr.Lpf.TRANSLUCENT_NAVIGATION] 时，此Flag会被系统会自动添加
         */
         ...
         * 当window设置 [CWinMgr.Lpf.TRANSLUCENT_STATUS] 时，此Flag会被系统会自动添加
         */
