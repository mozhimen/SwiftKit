 ...
 * @Version 1.0
 */
class FlowKRuntimeCallback : IFlowKListener {
    ...
    private fun logTaskKRuntimeInfo(flowKNode: FlowKNode) {
        ...
        val startTime = taskKRuntimeInfo.stateTime[FlowKState.START]
        val runningTime = taskKRuntimeInfo.stateTime[FlowKState.RUNNING]
        val finishedTime = taskKRuntimeInfo.stateTime[FlowKState.FINISHED]
