...
object UtilMKFile {
    ...
    fun getAssetsLicenseContent(licenseFileName: String?): String? {
        ...
        try {
            inputStream = UtilMKGlobal.instance.getApp()!!.assets.open(licenseFileName!!)
    ...
    fun getAssetsTxtContent(path: String?): String? {
        try {
            val stream = UtilMKGlobal.instance.getApp()!!.assets.open(path!!)
    ...
    fun copyAssetsToFile(fileName: String?, destFilePath: String): String? {
        var destAbsolutePath: String? = StringBuilder()
            ...
            .append(fileName)
            .toString()
        val assetManager = UtilMKGlobal.instance.getApp()!!.assets
        var inputStream: InputStream? = null
