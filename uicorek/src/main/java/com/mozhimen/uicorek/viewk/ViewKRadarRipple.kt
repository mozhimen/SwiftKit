...
class ViewKRadarRipple @JvmOverloads constructor(
    ...
    override fun initAttrs(attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        _bgColor = typedArray.getColor(R.styleable.ViewKRadarRipple_viewKRadarRipple_bgColor, _bgColor)
        _radarColor = typedArray.getColor(R.styleable.ViewKRadarRipple_viewKRadarRipple_radarColor, _radarColor)
        _lineColor = typedArray.getColor(R.styleable.ViewKRadarRipple_viewKRadarRipple_lineColor, _lineColor)
        _lineAlpha = typedArray.getInteger(R.styleable.ViewKRadarRipple_viewKRadarRipple_lineAlpha, _lineAlpha)
        _lineWidth = typedArray.getDimensionPixelSize(R.styleable.ViewKRadarRipple_viewKRadarRipple_lineWidth, _lineWidth)
        _lineCount = typedArray.getInteger(R.styleable.ViewKRadarRipple_viewKRadarRipple_lineCount, _lineCount)
        _moveAngleStep = typedArray.getInteger(R.styleable.ViewKRadarRipple_viewKRadarRipple_angleStep, _moveAngleStep)
        _animTime = typedArray.getInteger(R.styleable.ViewKRadarRipple_viewKRadarRipple_animTime, _animTime)
        typedArray.recycle()
    }
