 ...
 * @Version 1.0
 */
class ViewKCircleSpread @JvmOverloads constructor(
    ...
    override fun initAttrs(attrs: AttributeSet?, defStyleAttr: Int) {
        attrs ?: return
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.ViewKCircleSpread)
        _centerColor =
            typedArray.getColor(R.styleable.ViewKCircleSpread_viewKCircleSpread_centerColor, _centerColor)
        _centerDrawable =
            typedArray.getDrawable(R.styleable.ViewKCircleSpread_viewKCircleSpread_centerDrawable)
        _centerRadius = typedArray.getDimensionPixelSize(
            R.styleable.ViewKCircleSpread_viewKCircleSpread_centerRadius,
            _centerRadius
        )
        _spreadColor =
            typedArray.getColor(R.styleable.ViewKCircleSpread_viewKCircleSpread_spreadColor, _spreadColor)
        _spreadCount =
            typedArray.getInteger(R.styleable.ViewKCircleSpread_viewKCircleSpread_spreadCount, _spreadCount)
        _spreadIsRipple = typedArray.getBoolean(
            R.styleable.ViewKCircleSpread_viewKCircleSpread_spreadIsRipple,
            _spreadIsRipple
        )
        _circlesDistance =
            typedArray.getDimensionPixelOffset(
                R.styleable.ViewKCircleSpread_viewKCircleSpread_circlesDistance,
                _circlesDistance
            )
        _animTime = typedArray.getInteger(R.styleable.ViewKCircleSpread_viewKCircleSpread_animTime, _animTime)
        typedArray.recycle()
