package com.mozhimen.uicorek.viewk.wheel;
 ...
 * 3d滚轮控件
 */
public class ViewKWheel extends View {
    ...
    public ViewKWheel(Context context) {
        this(context, null);
    }

    public ViewKWheel(Context context, AttributeSet attrs) {
        super(context, attrs);

        textSize = getResources().getDimensionPixelSize(R.dimen.viewk_wheel_textsize);//默认大小
