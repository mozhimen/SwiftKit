...
import com.mozhimen.uicorek.tabk.bottom.cons.ETabKBottomType
 ...
 * @Version 1.0
 */
class MTabKBottom : Serializable {
    ...
    var tabKType: ETabKBottomType? = null
    ...
    constructor(
        ...
        this.tabKType = ETabKBottomType.IMAGE
    }
    ...
    constructor(
        ...
        this.tabKType = ETabKBottomType.IMAGE_TEXT
    }
    ...
    constructor(
        ...
        this.iconColorDefault = iconColorDefault.asColorTone()
        this.iconColorSelected = iconColorSelected.asColorTone()
        this.tabKType = ETabKBottomType.ICONFONT_TEXT
    }
}
