 ...
 * @Version 1.0
 */
class DataKAdapter(private val _context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private var _inflater: LayoutInflater = LayoutInflater.from(_context)
    private var _dataSets = ArrayList<DataKItem<*, out RecyclerView.ViewHolder>>()
     ...
     */
    fun removeItem(dataItem: DataKItem<*, out RecyclerView.ViewHolder>) {
    ...
    fun getItem(position: Int): DataKItem<*, RecyclerView.ViewHolder>? {
        ...
        return _dataSets[position] as DataKItem<*, RecyclerView.ViewHolder>
    }
     ...
     * @param dataItem DataKItem<*, out ViewHolder>
     */
    fun refreshItem(dataItem: DataKItem<*, out RecyclerView.ViewHolder>) {
