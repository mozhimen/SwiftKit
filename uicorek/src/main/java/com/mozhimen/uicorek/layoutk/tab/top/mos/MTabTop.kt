...
open class MTabTop {
    ...
    constructor(
        ...
        this.colorIndicator = UtilKColor.colorString2Int(colorIndicator)
    ...
    constructor(
        ...
        this.name = name
        this.colorDefault = UtilKColor.colorString2Int(colorDefault)
        this.colorSelected = UtilKColor.colorString2Int(colorSelected)
