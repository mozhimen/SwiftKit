...
class SearchKLayout @JvmOverloads constructor(
    ...
    private val _refHandler = RefHandler(this)
    ...
    fun setDebounceTextChangedListener(searchKTextWatcher: SearchKTextWatcher) {
        this._searchKTextWatcher = searchKTextWatcher
    }
        ...
        _editText?.addTextChangedListener(object : SearchKTextWatcher() {
            override fun afterTextChanged(p0: Editable?) {
                ...
                if (_searchKTextWatcher != null) {
                    _refHandler.removeCallbacks(_debounceRunnable)
                    _refHandler.postDelayed(_debounceRunnable, DEBOUNCE_TRIGGER_DURATION)
                }
            }
        })
    }
    ...
    private fun initSearchIconHintContainer() {
        ...
        _hintText?.id = R.id.searchk_txt_hint
        ...
        _searchIcon?.id = R.id.searchk_txt_icon_search
    ...
    private fun initClearIcon() {
        ...
        //默认隐藏,只有当输入文字时才会显示
        changeVisibility(_clearIcon, false)
        _clearIcon?.id = R.id.searchk_txt_icon_clear
    ...
    private fun initEditText() {
        ...
        _editText?.id = R.id.searchk_edit_search
    ...
    private fun ensureKeywordContainer() {
        ...
        if (!TextUtils.isEmpty(_attrs.keywordIcon)) {
            ...
            _keywordIcon?.id = R.id.searchk_txt_icon_keyword
        ...
        _keywordText?.id = R.id.searchk_txt_keyword
