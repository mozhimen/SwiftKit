...
import com.mozhimen.basick.elemk.handler.WeakHandler;
 ...
 * dialog基类
 */
public abstract class BaseDialog<L extends IDialogClickListener> extends Dialog {
    ...
    protected BaseDialog(@NonNull Context context) {
        this(context, R.style.BaseDialog_Style);
    }
    ...
    protected int onInitWindowWidth() {
        return Math.round(UtilKScreen.getScreenWidth2() * 0.8f);
    }
