...
import com.mozhimen.uicorek.commons.IViewK
 ...
 * @Version 1.0
 */
abstract class BaseViewK @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr),
    IViewK {
    var centerX = 0f
    var centerY = 0f
