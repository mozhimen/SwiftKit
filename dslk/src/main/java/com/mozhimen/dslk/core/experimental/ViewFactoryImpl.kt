package com.mozhimen.dslk.core.experimental

/**
 * @ClassName ViewFactoryImpl
 * @Description TODO
 * @Author mozhimen
 * @Date 2024/9/2
 * @Version 1.0
...
import com.mozhimen.dslk.core.*
import com.mozhimen.kotlin.utilk.kotlin.collections.forEachReversedByIndex
...
class ViewFactoryImpl : ViewFactory {
    ...
    override operator fun <V : View> invoke(clazz: Class<out V>, context: Context): V {
        ...
        throw IllegalArgumentException("No factory found for this type: $clazz")
    }
