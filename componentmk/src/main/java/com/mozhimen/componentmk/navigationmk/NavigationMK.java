 ...
 */
@Navigator.Name("navigationmk")
public class NavigationMK extends Navigator<NavigationMK.Destination> {
    private static final String TAG = "NavigatorMK>>>>>";
    ...
    public NavigationMK(@NonNull Context context, @NonNull FragmentManager manager,
                        int containerId) {
        mContext = context;
    ...
    public static class Destination extends NavDestination {
        ...
        public Destination(@NonNull NavigatorProvider navigatorProvider) {
            this(navigatorProvider.getNavigator(NavigationMK.class));
        }
